...
sudo cp Adding-CHIPDIP-DAC-to-Raspberry-Pi/./chipdip-dac-driver_v1 /home/./chipdip-dac-driver_v1
sudo chmod +x /home/./chipdip-dac-driver_v1
sudo sed -i '/^exit 0/i home/./chipdip-dac-driver_v1 &' /etc/rc.local
